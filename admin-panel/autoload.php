        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <?php } ?>
                    <?php if ($is_admin == true) { ?>
                    <li <?php echo ($page == 'manage-users' || $page == 'manage-user-verification' || $page == 'manage-genders' || $page == 'add-genders' || $page == 'edit-genders' || $page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field' || $page == 'manage-success-stories' || $page == 'add-success-stories' || $page == 'edit-success-stories') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                    ...
                    <li <?php echo ($page == 'manage-photos' ) ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-photos') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-photos'); ?>">Manage photos</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'fake-users' || $page == 'manage-announcements' ) ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
