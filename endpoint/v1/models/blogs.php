    ...
    public function Articles($data = null){
        ...
        if (empty($_POST['access_token'])) {
            ...
            foreach ($articles as $key => $article) {
                $article_array[$article['id']] = $article;
                $article_array[$article['id']]['thumbnail'] = GetMedia($article['thumbnail']);
                $article_array[$article['id']]['category_name'] = Dataset::blog_categories()[$article['category']];
            }
            return json(array(
                'data' => $article_array,
                'code' => 200
