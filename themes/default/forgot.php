...
<!-- Login  -->
	<div class="container-fluid auth_bg_img">
		...
		<div class="usr_circle mdm" style="background-image: url(<?php echo $theme_url;?>assets/img/login4.jpg);"></div>
		<div class="usr_circle mlr" style="background-image: url(<?php echo $theme_url;?>assets/img/login2.jpg);"></div>
