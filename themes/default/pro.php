				...
				<div class="row dt_prem_row">
					<div class="col s12 m7 l5">
						<div class="dt_choose_pro">
							...
							<p>
								<!--<label>-->
								<!--	<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( 'Weekly' );?>" data-price="<?php echo (int)$config->weekly_pro_plan;?>"/>-->
								<!--	<span class="pln_name">-->
								<!--		<span class="duration"><?php echo __( 'Weekly' );?></span>-->
								<!--		<span class="price"><?php echo $config->currency_symbol . (int)$config->weekly_pro_plan;?></span>-->
								<!--	</span>-->
								<!--</label>-->
							</p>
							<p>
								<label>
									<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( 'Monthly' );?>" data-price="<?php echo (int)$config->monthly_pro_plan;?>" checked />
									<span class="pln_name">
										...
										<span class="price"><?php echo $config->currency_symbol . (int)$config->monthly_pro_plan;?></span>
									</span>
								</label>
							</p>
							<p>
								<!--<label>-->
								<!--	<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( 'Yearly' );?>" data-price="<?php echo (int)$config->yearly_pro_plan;?>"/>-->
								<!--	<span class="pln_name">-->
								<!--		<span class="duration"><?php echo __( 'Yearly' );?></span>-->
								<!--		<span class="price"><?php echo $config->currency_symbol . (int)$config->yearly_pro_plan;?></span>-->
								<!--	</span>-->
								<!--</label>-->
							</p>
							<p>
								<!--<label>-->
								<!--	<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( 'Lifetime' );?>" data-price="<?php echo (int)$config->lifetime_pro_plan;?>"/>-->
								<!--	<span class="pln_name">-->
								<!--		<span class="duration"><?php echo __( 'Lifetime' );?></span>-->
								<!--		<span class="price"><?php echo $config->currency_symbol . (int)$config->lifetime_pro_plan;?></span>-->
								<!--	</span>-->
								<!--</label>-->
							</p>
							<div class="pay_using center">
								...
								<div class="pay_u_btns valign-wrapper">
									<button id="paypal" class="btn paypal valign-wrapper">
									...
									<button id="" class="btn stripe valign-wrapper"><?php echo __( 'Card' );?> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M20,8H4V6H20M20,18H4V12H20M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z"></path></svg></button>
									<button id="stripe_pro_btn" class="hide"></button>
                                    <?php if(!empty($config->bank_description)){?>
                                        <button id="" class="btn valign-wrapper bank"><?php echo __( 'Bank Transfer' );?> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M15,14V11H18V9L22,12.5L18,16V14H15M14,7.7V9H2V7.7L8,4L14,7.7M7,10H9V15H7V10M3,10H5V15H3V10M13,10V12.5L11,14.3V10H13M9.1,16L8.5,16.5L10.2,18H2V16H9.1M17,15V18H14V20L10,16.5L14,13V15H17Z"></path></svg></button>
                                    <?php } ?>

                                    <?php if(!empty($config->paysera_password)){?>
                                        <button id="sms_payment" class="btn valign-wrapper sms"><?php echo __( 'SMS' );?> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M17,19V5H7V19H17M17,1A2,2 0 0,1 19,3V21A2,2 0 0,1 17,23H7C5.89,23 5,22.1 5,21V3C5,1.89 5.89,1 7,1H17M9,7H15V9H9V7M9,11H13V13H9V11Z"></path></svg></button>
                                    <?php } ?>
                                </div>
						...
						<div class="dt_pro_features">
							...
							<div class="row">
                                ...
                                <div class="col s12 m12 l4 center">
                                    ...
                                    <p><?php echo __( 'Travel to another country, and relocate!' );?></p>
                                </div>
								<div class="col s12 m12 l4 center"></div>
							</div>
