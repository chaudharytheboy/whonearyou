                            ...
                            <form class="slider-form slider-one" style="<?php if( $config->image_verification == 1 && $profile->status == 3 ){ ?>padding: 0px;<?php }?>">
                                <div class="choose_photo <?php if( $profile->status == 3 ){ ?>hide<?php }?>">
                                    ...
                                    <?php if( $profile->avater->full !== '' ){?>
                                        <span class="dt_selct_avatar" onclick="document.getElementById('avatar_img').click(); return false" style="background-image: url(<?php echo $profile->avater->full ;?>);background-repeat: no-repeat;background-size: cover;background-position: center center;border: inherit;">
                                ...
                                <div class="step_footer">
                                    <button class="waves-effect waves-light btn btn_primary bold first next" id="btn-upload-images" disabled data-selected="" data-defaultText="<?php echo __( 'Next' );?>"><span id="nexttext"><?php echo __( 'Next' );?></span> <svg viewBox="0 0 19 14" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path fill="currentColor" d="M18.6 6.9v-.5l-6-6c-.3-.3-.9-.3-1.2 0-.3.3-.3.9 0 1.2l5 5H1c-.5 0-.9.4-.9.9s.4.8.9.8h14.4l-4 4.1c-.3.3-.3.9 0 1.2.2.2.4.2.6.2.2 0 .4-.1.6-.2l5.2-5.2h.2c.5 0 .8-.4.8-.8 0-.3 0-.5-.2-.7z"></path></svg></button>
                                </div>
                            </form>
