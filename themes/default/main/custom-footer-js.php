    ...
    function custom_footer_js(page_name=''){
        <?php if( isset( $_SESSION['JWT'] ) ){ ?>
            ...
            $.fancybox.defaults.btnTpl.del = '<button data-fancybox-del class="fancybox-button fancybox-button--del" title="Delete image"  onClick="javascript:deleteimage(this)" >' +
                ...
                '</button>';
            $.fancybox.defaults.btnTpl.prvt = '<button data-fancybox-prvt class="fancybox-button fancybox-button--prvt" title="Make it private image"  onClick="javascript:privateimage(this)" >' +
                ...
                '</button>';
            $.fancybox.defaults.btnTpl.remove_prvt = '<button data-fancybox-remove-prvt class="fancybox-button fancybox-button--remove-prvt" title="Make it public image"  onClick="javascript:unprivateimage(this)" >' +
            ...
            if ( window.isadmin === "1" ){
                if( page_name === "profile" ){
                    $.fancybox.defaults.btnTpl.del = '<button data-fancybox-del class="fancybox-button fancybox-button--del" title="Delete image"  onClick="javascript:deleteimageadmin(this,<?php echo $profile->id;?>)" >' +
                        '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>'  +
                        '</button>';
                }
            }
